...
\usepackage{enumitem}
\setenumerate[1]{itemsep=5pt,partopsep=0pt,parsep=\parskip,topsep=5pt,itemindent=1em,leftmargin=3.5pt}
\setitemize[1]{itemsep=0pt,partopsep=0pt,parsep=\parskip,topsep=5pt,itemindent=1em,leftmargin=3.5pt}
\setdescription{itemsep=0pt,partopsep=0pt,parsep=\parskip,topsep=5pt,itemindent=1em,leftmargin=3.5pt}
	...
	\begin{multicols}{2}
		\section{数学}
			...
			\subsection{常见数列}
				...
				\subsubsection{欧拉数(Eulerian Number)(待完成)}
		...
		\section{数论}
			...
			\subsection{中国剩余定理(待完成)}

				\subsubsection{ex-CRT(待完成)}
		...
		\section{图论}
			...
			\subsection{一般图匹配}
				...
				\subsubsection{带权带花树}
					Forked from templates of Imperisible Night.
		...
		\newpage
		\section{计算几何}
			\subsection{Delaunay三角剖分 Voronoi图(待完成)}
