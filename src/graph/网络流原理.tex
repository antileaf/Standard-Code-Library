...
\begin{tikzpicture}[scale=0.95]
	\node[draw, circle, thick] (u0) at (-5, -1) {u};
	\node[draw, circle, thick] (v0) at (-3, -1) {v};

	\draw[->, thick] (u0) -- node[midway, below] {[b, c]} (v0);

	\coordinate (left) at (-2, -1);
	\coordinate (right) at (-1, -1);

	\draw[->, very thick] (left) -- (right);

	\node[draw, circle, thick] (S) at (0, 0) {\phantom{'}S'};
	\node[draw, circle, thick] (T) at (4, 0) {\phantom{'}T'};
	\node[draw, circle, thick] (u) at (1, -2) {u};
	\node[draw, circle, thick] (v) at (3, -2) {v};

	\draw[->, thick] (S) -- node[pos=0.3, below] {b} (v);
	\draw[->, thick] (u) -- node[pos=0.7, below] {b} (T);
	\draw[->, thick] (u) -- node[midway, below] {c-b} (v);
\end{tikzpicture}
