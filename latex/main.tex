...
\begin{document}
	...
	\begin{titlepage}
		\ThisCenterWallPaper{1.015}{image/lily_face.png}
	...
	\begin{multicols}{2}
		\section{数学}
			...
			\subsection{多项式}
				...
				\subsubsection[Bostan-Mori（求多项式分式第 n 项）]{Bostan-Mori}
					\label{BostanMori}
					\input{../src/math/Bostan-Mori.tex}
				
				\subsubsection{快速线性递推 $O(k\log k\log n)$}
					\label{LinearRecurrence}
					\input{../src/math/快速线性递推.tex}

				\subsubsection{多项式复合逆}
					\label{PolyCompositeInverse}
					\input{../src/math/多项式复合逆.tex}
				
				\subsubsection{多项式复合}
					\input{../src/math/多项式复合.tex}
			...
			\subsection{线性代数}
				稀疏矩阵操作参见 \detailedref{BerlekampMasseyApplication}。
				...
				\subsubsection{矩阵树定理，BEST 定理}
					\input{../src/math/矩阵树定理.tex}
			
			\subsection{$O(k^2 \log n)$ 齐次线性递推}
				\mintinline{cpp}{first} 里面是第 $1$ 到 $k$ 项，\mintinline{cpp}{trans} 从低到高分别是 $a_{n - 1}$ 到 $a_{n - k}$ 的系数。
			...
			\subsection{博弈论}
				\subsubsection{SG 定理}
					\input{../src/math/SG定理.tex}

				\subsubsection{纳什均衡}
					\input{../src/math/纳什均衡.tex}

				\subsubsection{经典博弈}
					\label{classicgame}
					\input{../src/math/经典博弈.tex}

				\subsubsection{例题}
					\input{../src/math/博弈论例题.tex}
		...
		\section{数论}
			...
			\subsection{洲阁筛}
				\input{../src/numbertheory/洲阁筛.tex}
		...
		\section{图论}
			...
			\subsection{最小生成树}
				...
				\subsubsection[斯坦纳树 Steiner Tree]{斯坦纳树}
			...
			\subsection{最短路}
				\subsubsection{Dijkstra}
					参见 \detailedref{kshortestpath}，注意那边是求到 $t$ 的最短路。
		...
		\section{数据结构}
			...
			\subsection{堆}
				...
				\subsubsection{左偏树}
					参见 \detailedref{kshortestpath}。
				
				\subsubsection{二叉堆}
					\inputminted{cpp}{../src/datastructure/二叉堆.cpp}
			
			\subsection{莫队}
				\input{../src/datastructure/莫队.tex}
				\input{../src/datastructure/莫队例题.tex}
	...
	\begin{multicols}{2}
		\section{杂项}
			...
			\subsection{GarsiaWachs 算法（$O(n\log n)$ 合并石子）}
				\input{../src/misc/garsiawachs.tex}
			...
			\subsection{一些游戏}
				...
				\subsubsection{炉石传说}
					\input{../src/misc/炉石.tex}

			\subsection{OEIS}
				\label{oeis}
				\input{../src/misc/oeis.tex}
		...
		\section{附录}
			...
			\subsection{VScode 相关}
				\input{../src/misc/vscode.tex}
			
			\newpage
			\subsection{骂人的艺术—梁实秋}
				\input{../src/misc/骂人的艺术.tex}
	...
	\newpage
	\ThisCenterWallPaper{1.015}{image/lily.jpg}
