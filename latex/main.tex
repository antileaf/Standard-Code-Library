...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\section{数据结构}
			...
			\section{其他算法}
				\subsection{$O(1)$快速乘}
					% \inputminted{cpp}{../src/其它算法/O(1)快速乘.cpp}
				
				\subsection{$O(n^2)$高精度}
					% \inputminted{cpp}{../src/其它算法/高精度.cpp}

				\subsection{xorshift}
					% \inputminted{cpp}{../src/其它算法/xorshift.cpp}

			\section{参考资料}
				\subsection{常见数列}
					\subsubsection{伯努利数}
						\input{../src/参考资料/伯努利数.tex}

			\section{注意事项}
				\subsection{常见下毒手法}
					\input{../src/注意事项/常见下毒手法.tex}

				\subsection{场外相关}
					\input{../src/注意事项/场外相关.tex}

				\subsection{做题策略与心态调节}
					\input{../src/注意事项/做题策略与心态调节.tex}
